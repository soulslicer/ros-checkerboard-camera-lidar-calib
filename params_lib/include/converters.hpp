        ...
        public:
            ...
            bool load(handle src, bool)
            {
                ...
                if (info.format == format_descriptor<float>::format()) {
                    ...
                    throw std::logic_error("Unsupported type numpy to cv::Mat");
                    return false;
                }
            ...
            static handle cast(const cv::Mat &m, return_value_policy, handle defval)
            {
                ...
                switch(m.type()) {
                    ...
                    case CV_32FC4:
                        ...
                        break;
                    default:
                        throw std::logic_error("Unsupported type cv::Mat to numpy");
                }
                ...
                } else if (dim == 3 && channels == 3) {
                    bufferdim = {(size_t) m.rows, (size_t) m.cols, (size_t) 3};
                    strides = {(size_t) elemsize * m.cols * 3, (size_t) elemsize * 3, (size_t) elemsize};
                } else if (dim == 3 && channels == 4) {
                    bufferdim = {(size_t) m.rows, (size_t) m.cols, (size_t) 4};
                    strides = {(size_t) elemsize * m.cols * 4, (size_t) elemsize * 4, (size_t) elemsize};
                }
